      ...
      children: [
        ...
        if (pokemonDetailModel.types != null)
          Row(
            ...
            children: pokemonDetailModel.types!.map((type) {
              return Container(
                margin:
        ...
        Row(
          ...
          children: [
            Column(
              children: [
                if (pokemonDetailModel.weight != null)
                  Text(
                    //dividing by 10 to convert from hectogram to kilogram
                    "${pokemonDetailModel.weight! / 10} kg",
                    style: AppTextStyles.displayLarge.copyWith(fontSize: 30),
                  ),
                const Text(
                  "Weight",
            ...
            Column(
              children: [
                if (pokemonDetailModel.height != null)
                  Text(
                    //dividing by 10 to convert from decimeter to meters
                    "${pokemonDetailModel.height! / 10}m",
                    style: AppTextStyles.displayLarge.copyWith(fontSize: 30),
                  ),
                const Text(
                  "Height",
